...
REQUIRED_PUBLIC_FILES = [
    ...
    "scripts/fetch_open_access_hypertrophy_reviews.py",
    "scripts/fetch_open_access_training_science_reviews.py",
    ...
    "data/exercises/training_anatomy.json",
    ...
    "sportrx/hypertrophy_atlas.py",
    "sportrx/training_anatomy.py",
    "sportrx/knowledge_discovery.py",
    "sportrx/knowledge_rag.py",
    "sportrx/prescription_knowledge.py",
    ...
    "evidence/knowledge/evaluation/equivalence_set.json",
    "evidence/knowledge/packs/goal_prescription_v1.json",
    "evidence/knowledge/packs/hypertrophy_movement_v1.json",
    "evidence/knowledge/packs/training_anatomy_v1.json",
    "evidence/knowledge/packs/training_science_v1.json",
    "evidence/records/packs/goal_prescription_sources.json",
    "evidence/records/packs/goal_prescription_claims.json",
    "evidence/records/packs/hypertrophy_movement_sources.json",
    "evidence/records/packs/hypertrophy_movement_claims.json",
    "evidence/records/packs/training_anatomy_sources.json",
    "evidence/records/packs/training_anatomy_claims.json",
    "evidence/records/packs/training_science_sources.json",
    "evidence/records/packs/training_science_claims.json",
    "evidence/anatomy/README.md",
    "evidence/anatomy/manifest.json",
    "evidence/anatomy/coverage.md",
    "evidence/anatomy/fulltext_access.md",
    "evidence/anatomy/review_log.md",
    "evidence/training_science/README.md",
    "evidence/training_science/manifest.json",
    "evidence/training_science/topic_map.md",
    "evidence/training_science/fulltext_access.md",
    "evidence/training_science/review_log.md",
    "evidence/hypertrophy/README.md",
    "evidence/hypertrophy/manifest.json",
    "evidence/hypertrophy/movement_taxonomy.md",
    "evidence/hypertrophy/muscle_regions.md",
    "evidence/hypertrophy/exercise_selection.md",
    "evidence/hypertrophy/review_log.md",
    "evidence/prescription/README.md",
    "evidence/prescription/manifest.json",
