...
MINIMUM_RULES = [
    ...
    "Capture an explicit consent status and version before any real participant data are entered.",
    "Review retention dates and honor a deletion request through a documented local workflow.",
